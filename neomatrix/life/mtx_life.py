...
class ConwaysLifeAnimation(Animation):
    ...
    def __init__(
        ...
        :param matrix_object: The initialised 2D neopixel matrix object (using a NeoGrid).
        ...
        # use a NeoMatrix.NeoGrid object to access our strand as a 2D grid
        self.pixel_grid = matrix_object._grid

        self.pixel_object = matrix_object._grid._pixels
        super().__init__(self.pixel_object, speed, color)
        ...
        # size of the grid
        self.width = matrix_object._width
        self.height = matrix_object._height
    ...
    def _init_cells(self):
        """
        Turn off all LEDs then turn on ones corresponding to the initial_cells
